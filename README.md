...
| -------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| LebronJames <br> Password            | Welcome!'! <br> "1. Login." <br><br> "2. Register Account." <br><br> "3. Exit Program." <br><br> USERNAME: LebronJames <br> PASSWORD: Password <br> <br> First Name: Lebron <br> Last Name: James  |
| Kobe <br> Bryant            | Welcome!'! <br> "1. Login." <br><br> "2. Register Account." <br><br> "3. Exit Program." <br><br> USERNAME: Kobe <br> PASSWORD: Bryant <br> ERROR: User ID does not exist! <br> Register first instead! |
