...
|1. login<br> Kobe <br>  BlackMamba           | Welcome!'! <br> "1. Login." <br><br> "2. Register Account." <br><br> "3. Exit Program." <br><br> USERNAME: KobeBryant <br> PASSWORD: BlackMamba <br> ERROR: User ID does not exist! <br> Register first instead! |
